...
class AES_Util(Crypto):
    ...
    #  +----+----+----+----+           +----+----+----+----+
        result_state = [0] * 16
        for i in range(4):
            result_state[i*4+0] = gmul[1][state[i*4+0]]^gmul[2][state[i*4+1]]^gmul[0][state[i*4+2]]^gmul[0][state[i*4+3]]
            result_state[i*4+1] = gmul[0][state[i*4+0]]^gmul[1][state[i*4+1]]^gmul[2][state[i*4+2]]^gmul[0][state[i*4+3]]
            result_state[i*4+2] = gmul[0][state[i*4+0]]^gmul[0][state[i*4+1]]^gmul[1][state[i*4+2]]^gmul[2][state[i*4+3]]
            result_state[i*4+3] = gmul[2][state[i*4+0]]^gmul[0][state[i*4+1]]^gmul[0][state[i*4+2]]^gmul[1][state[i*4+3]]
        return result_state
    ...
    #  +----+----+----+----+           +----+----+----+----+
        result_state = [0] * 16
        for i in range(4):
            result_state[i*4+0] = inv_gmul[3][state[i*4+0]]^inv_gmul[1][state[i*4+1]]^inv_gmul[2][state[i*4+2]]^inv_gmul[0][state[i*4+3]]
            result_state[i*4+1] = inv_gmul[0][state[i*4+0]]^inv_gmul[3][state[i*4+1]]^inv_gmul[1][state[i*4+2]]^inv_gmul[2][state[i*4+3]]
            result_state[i*4+2] = inv_gmul[2][state[i*4+0]]^inv_gmul[0][state[i*4+1]]^inv_gmul[3][state[i*4+2]]^inv_gmul[1][state[i*4+3]]
            result_state[i*4+3] = inv_gmul[1][state[i*4+0]]^inv_gmul[2][state[i*4+1]]^inv_gmul[0][state[i*4+2]]^inv_gmul[3][state[i*4+3]]
        return result_state 
    ...
    #  +----+----+----+----+             +----+----+----+----+
        return [state[0x00], state[0x05], state[0x0A], state[0x0F], \
                state[0x04], state[0x09], state[0x0E], state[0x03], \
                state[0x08], state[0x0D], state[0x02], state[0x07], \
                state[0x0C], state[0x01], state[0x06], state[0x0B]]
    ...
    #  +----+----+----+----+                +----+----+----+----+
        return [state[0x00], state[0x0D], state[0x0A], state[0x07], \
                state[0x04], state[0x01], state[0x0E], state[0x0B], \
                state[0x08], state[0x05], state[0x02], state[0x0F], \
